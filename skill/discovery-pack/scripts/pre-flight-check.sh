...
# Verifies templates/, schemas/, scripts/ directories exist relative to skill root
...
MISSING=0
for dir in templates schemas scripts shared-references; do
...
if [ $MISSING -gt 0 ]; then
    echo ""
    echo "❌ Skill structure incomplete (missing $MISSING directories)"
    exit 1
fi
echo ""
